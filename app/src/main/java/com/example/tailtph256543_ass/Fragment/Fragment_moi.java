...
public class Fragment_moi extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_congviec_moi,container,false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        lv_list = view.findViewById(R.id.rc_moi);
        sv_ = view.findViewById(R.id.sv_moi);
        ...
        listCheck = loc(list);
        adapter_task = new Adapter_cv(getContext(), listCheck,0,quanLyCongViec.Guidata().getId());
