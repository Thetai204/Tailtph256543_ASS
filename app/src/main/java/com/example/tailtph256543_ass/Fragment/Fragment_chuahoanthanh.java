...
public class Fragment_chuahoanthanh extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_cong_viec_chua_hoan_thanh,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listCheck = loc(list);
        adapter_cv = new Adapter_cv(getContext(), listCheck,1,quanLyCongViec.Guidata().getId());
